...
frame.pack(pady=0, padx=60, fill="y", expand=True)

label = ck.CTkLabel(master=frame, text="What is your spacecraft transmitter power (in Watts)?")
label.pack(pady=0, padx=0, side="top")
P1 = ck.CTkEntry(master=frame, placeholder_text="Watts")
P1.pack(pady=0, padx=0)
#print('What is your spacecraft transmitter power (in Watts)?')
#P = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your groundstation transmitter power (in Watts)?")
label.pack(pady=0, padx=0, side="top")
P_up1 = ck.CTkEntry(master=frame, placeholder_text="Watts")
P_up1.pack(pady=0, padx=0)
#print('What is your groundstation transmitter power (in Watts)?')
#P_up = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your spacecraft transmitter loss factor?")
label.pack(pady=0, padx=0, side="top")
L_TX1 = ck.CTkEntry(master=frame, placeholder_text="Factor")
L_TX1.pack(pady=0, padx=0)
#print('What is your spacecraft transmitter loss factor?')
#L_TX = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your ground station transmitter loss factor?")
label.pack(pady=0, padx=0, side="top")
L_TX_up1 = ck.CTkEntry(master=frame, placeholder_text="Factor")
L_TX_up1.pack(pady=0, padx=0)
#print('What is your ground station transmitter loss factor?')
#L_TX_up = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is the frequency of your downlink signal (in GHz)?")
label.pack(pady=0, padx=0, side="top")
f1 = ck.CTkEntry(master=frame, placeholder_text="GHz")
f1.pack(pady=0, padx=0)
#print('What is the frequency of your downlink signal (in GHz)?')
#f =  float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your turnaround ratio (in decimal form)?")
label.pack(pady=0, padx=0, side="top")
f_up_down_ratio1 = ck.CTkEntry(master=frame, placeholder_text="Decimal")
f_up_down_ratio1.pack(pady=0, padx=0)
#print('What is your turnaround ratio (in decimal form)?')
#f_up_down_ratio = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is the diameter of your spacecraft antenna (in meters)?")
label.pack(pady=0, padx=0, side="top")
d1 = ck.CTkEntry(master=frame, placeholder_text="Meters")
d1.pack(pady=0, padx=0)
#print('What is the diameter of your spacecraft antenna?')
#d = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is the diameter of your receiving antenna (in meters)?")
label.pack(pady=0, padx=0, side="top")
D1 = ck.CTkEntry(master=frame, placeholder_text="Meters")
D1.pack(pady=0, padx=0)
...
label = ck.CTkLabel(master=frame, text="At what altitude above the celestial body does your spacecraft orbit (in meters)?")
label.pack(pady=0, padx=0, side="top")
orbit_alt1 = ck.CTkEntry(master=frame, placeholder_text="Meters")
...
label = ck.CTkLabel(master=frame, text="Which celestial body is your spacecraft orbiting?")
label.pack(pady=0, padx=0, side="top")
destination1 = ck.CTkComboBox(master = frame, values=["Earth", "Earths Moon", "Mars", "Venus"])
...
label = ck.CTkLabel(master=frame, text="What is your elongation  angle (in degrees)?")
label.pack(pady=0, padx=0, side="top")
theta_ES1 = ck.CTkEntry(master=frame, placeholder_text="Degrees")
theta_ES1.pack(pady=0, padx=0)


label = ck.CTkLabel(master=frame, text="What is your pointing offset angle (in degrees)?")
label.pack(pady=0, padx=0, side="top")
e_TX1 = ck.CTkEntry(master=frame, placeholder_text="Degrees")
e_TX1.pack(pady=0, padx=0)
#print('What is your pointing offset angle (in deg)?')
#e_TX = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your required uplink data rate (in bit/s)?")
label.pack(pady=0, padx=0, side="top")
B_R_up1 = ck.CTkEntry(master=frame, placeholder_text="bit/s")
B_R_up1.pack(pady=0, padx=0)
# print('What is your required uplink data rate (in bit/s)?')
# B_R_up = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your Payload swath width angle (in degrees)?")
label.pack(pady=0, padx=0, side="top")
P_SW1 = ck.CTkEntry(master=frame, placeholder_text="Degrees")
P_SW1.pack(pady=0, padx=0)
# print('What is your Payload swath width angle (in deg)?')
# P_SW = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your payload pixel size (in arcmin)?")
label.pack(pady=0, padx=0, side="top")
P_PXS1 = ck.CTkEntry(master=frame, placeholder_text="Arcmin")
P_PXS1.pack(pady=0, padx=0)
# print('What is your payload pixel size (in arcmin)?')
# P_PXS = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your payload bits per pixel?")
label.pack(pady=0, padx=0, side="top")
P_BPPX1 = ck.CTkEntry(master=frame, placeholder_text="bits/pixel")
P_BPPX1.pack(pady=0, padx=0)
# print('What is your payload bits per pixel?')
# P_BPPX = float(input('>'))

label = ck.CTkLabel(master=frame, text="What is your payload duty cycle (in percentage)?")
label.pack(pady=0, padx=0, side="top")
D_C1 = ck.CTkEntry(master=frame, placeholder_text="Percentage")
D_C1.pack(pady=0, padx=0)
# print('What is your payload duty cycle (in percent form)?')
# D_C = float(input('>'))

label = ck.CTkLabel(master=frame, text="How many hours per day of downlink time does your payload have?")
label.pack(pady=0, padx=0, side="top")
T_DL1 = ck.CTkEntry(master=frame, placeholder_text="Hours")
T_DL1.pack(pady=0, padx=0)
# print('How many hours per day of downlink time does your payload have?')
# T_DL = float(input('>'))

button = ck.CTkButton(master=frame, text="Run", command=main)
