...
#constants
G = 9.80665 #m/s^2
m_dry_with_initial_prop = 596 #kg

# Mission parameters
mission_duration = 4.5  # years
t_transfer = 8  # months
t_station = 3.3*365*24*60  #3.3 years
t_capture = 30 # minutes #30 for biprop
...
# Biprop: 3 thrusters (1 for redundancy)
biprop_base_mass = 3 * biprop['thruster_mass'] + 50
...
m_before_stkeeping, m_prop_stkeeping_electric = compute_mass_after_deltav(m_dry_corrected, deltav_station, electric['isp'])
...
m_initial_mission, m_prop_capture = compute_mass_after_deltav(m_before_stkeeping, deltav_capture, biprop['isp'])
...
v_pressurant, press_mass = compute_pressurant(v_prop_biprop, biprop['blow_down_ratio'], biprop['press_density'])
